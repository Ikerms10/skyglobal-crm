...
const SCOPE_OPTIONS = [
  ...
  'Walls Only',
  'Trim & Baseboards Only',
  'Ceilings Only',
  'Walls + Trim & Baseboards',
  'Walls + Ceilings',
  'Full Interior + Ceilings',
  'Accent Walls',
  'Custom Scope',
]
  ...
  return (
    <div style={S.page}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
        <div>
          <div style={{
            width: 64, height: 64, background: '#FFFFFF', borderRadius: 10,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 4, fontSize: 12 }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <div><strong>Date of Issuance:</strong>{' '}
            <EditableField value={data.issueDate} onChange={f('issueDate')} type="date" placeholder="Select date" />
          </div>
          <div><strong>Proposal Valid Until:</strong>{' '}
            <EditableField value={data.validUntil} onChange={f('validUntil')} type="date" placeholder="Select date" />
          </div>
        </div>
      </div>
          ...
          <div style={{ border: '1px solid #E0D5C7', borderLeft: '3px solid #4A6741', borderRadius: 6, padding: 20, fontSize: 12, lineHeight: 1.8 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              <div>
                ...
                <strong>Policy Number:</strong> CEG-00312198-00<br />
                <strong>Coverage Type:</strong> General Liability<br />
                <strong>Coverage Limit:</strong> $2,000,000
              </div>
              <div>
                <strong>Effective Date:</strong> On file<br />
                <strong>Expiration Date:</strong> On file<br />
                <strong>Phone:</strong> 352-782-2460<br />
